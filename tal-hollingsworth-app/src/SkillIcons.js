                    ...
                    <div className="grid-100 content">
                        ...
                        <div className="grid-75 grid-center">
                            <div className="d-flex flex-wrap flex-justify-between margin-bottom-20">
                                ...
                                <i className="ico ico-80 margin-30 flex-auto">
                                    <svg viewBox="0 0 342 480" width="100%" height="100%">
                                        <g id="#000000ff">
                                ...
                                <i className="ico ico-80 margin-30 flex-auto">
                                    <svg viewBox="0 0 547.8 410.6" width="100%" height="100%">
                                ...
                                <i className="ico ico-80 margin-30 flex-auto">
                                    <svg viewBox="0 0 284.5 74" width="100%" height="100%">
                                        <style type="text/css" dangerouslySetInnerHTML={{ __html: "\n                                        .st4{fill:#0769AD;}\n                                        .st5{fill:#333333;}\n                                    " }} />
                                        <g>
                                            <g>
                                                <path className="st4" d="M110.53,64.61c-0.02,0.61-0.06,1.24-0.14,1.91l2.49-4.51l-0.27-1.47l2.5-0.38l0.91,6.25l1.15-3.92
                                          ...
                                          C110.48,61.55,110.59,62.99,110.53,64.61z" />
                                                <path className="st4" d="M126.76,62.45c-1.21,0.65-1.66,0.9-2.75,1.57l-1.17,5.49h-2.7l1.9-9.08l2.38-0.4l-0.1,1.26
                                          c0.92-0.54,1.66-0.92,2.47-1.26L126.76,62.45z" />
                                                <path className="st4" d="M128.36,60.41l2.79-0.38l-2.01,9.48h-2.7L128.36,60.41z M129.23,56.29l2.79-0.38l-0.62,2.87l-2.77,0.38
                                          L129.23,56.29z" />
                                                <path className="st4" d="M136.11,62.36L135.13,67c-0.02,0.1-0.04,0.19-0.05,0.25c0,0.13,0.07,0.19,0.26,0.19
                                          ...
                                          l1.1-5.18h-1.38l0.46-2.16h1.38l0.46-2.24l2.79-0.38l-0.55,2.62h2.22l-0.61,2.16H136.11z" />
                                                <path className="st4" d="M139.32,63.52c0.46-2.14,1.46-3.52,4.41-3.52c1.76,0,3.07,0.76,3.02,2.33c-0.06,1.82-1.03,2.66-3.35,3.35
                                          ...
                                          C143.85,63.52,144.21,63.18,144.23,62.62z" />
                                                <path className="st4" d="M153.7,56.39l2.79-0.38l-2.84,13.5h-2.7L153.7,56.39z" />
                                                <path className="st4" d="M156.84,63.52c0.46-2.14,1.46-3.52,4.41-3.52c1.76,0,3.07,0.76,3.02,2.33c-0.06,1.82-1.03,2.66-3.35,3.35
                                          c-1.14,0.34-1.16,0.34-1.97,0.55l-0.14,0.65c-0.07,0.34-0.04,0.65,0.46,0.65c0.98,0,2.41-0.48,3.69-1.03l0.45,1.91
                                          c-1.15,0.71-2.95,1.28-4.59,1.28c-1.93,0-2.72-0.84-2.67-2.43c0.01-0.34,0.06-0.73,0.15-1.13L156.84,63.52z M161.74,62.62
                                          c0.01-0.33-0.27-0.54-0.76-0.54c-0.98,0-1.28,0.55-1.44,1.32l-0.14,0.65c0.46-0.12,0.67-0.15,1.23-0.33
                                          C161.37,63.52,161.72,63.18,161.74,62.62z" />
                                                <path className="st4" d="M164.48,69.09l0.59-1.99c0.7,0.25,1.49,0.48,2.51,0.48c0.9,0,0.96-0.27,1.06-0.71
                                          ...
                                          c-0.46,2.1-1.1,2.95-3.89,2.95C166.48,69.7,165.29,69.45,164.48,69.09z" />
                                                <path className="st4" d="M172.2,69.09l0.59-1.99c0.7,0.25,1.49,0.48,2.51,0.48c0.9,0,0.96-0.27,1.06-0.71c0.09-0.42-0.17-0.65-1.2-1.2
                                          c-1.91-1.03-1.97-1.72-1.67-3.12c0.43-2.01,1.04-2.54,3.63-2.54c0.88,0,2,0.19,2.76,0.44l-0.51,2.03
                                          c-0.68-0.19-1.69-0.34-2.34-0.34c-0.8,0-0.92,0.1-1.04,0.59c-0.09,0.44,0,0.54,0.88,1.01c2.1,1.15,2.41,1.55,2.09,3.02
                                          c-0.46,2.1-1.1,2.95-3.89,2.95C174.21,69.7,173.01,69.45,172.2,69.09z" />
                                                <path className="st4" d="M179.59,71.59l1.55-2.08h-1.01l0.67-3.17h2.7l-0.73,3.4l-2.22,2.64L179.59,71.59z" />
                                                <path className="st4" d="M194.33,69.51l-0.05-0.8c-0.69,0.55-1.66,0.99-3,0.99c-2.03,0-2.48-1.22-2.04-3.31l0.53-2.5
                                          ...
                                          L191.86,66.72z" />
                                                <path className="st4" d="M199.11,66.58c0.01-0.21,0.04-0.44,0.08-0.65l0.46-2.16c0.5-2.39,1.72-3.77,4.97-3.77
                                          ...
                                          C205.41,63.56,205.44,63.43,205.44,63.31z" />
                                                <path className="st4" d="M224.6,63.18c0.02-0.11,0.05-0.21,0.05-0.29c0.01-0.19-0.09-0.27-0.35-0.27c-0.5,0-1.68,0.5-2.46,0.9
                                          ...
                                          c1.24,0,1.68,0.71,1.64,1.89c-0.01,0.33-0.04,0.69-0.13,1.07l-1.38,6.54h-2.7L224.6,63.18z" />
                                                <path className="st4" d="M228.38,66.58c0.01-0.21,0.04-0.44,0.08-0.65l0.46-2.16c0.5-2.39,1.72-3.77,4.97-3.77
                                          c2.5,0,3.58,1.43,3.52,3.1c-0.01,0.21-0.04,0.44-0.08,0.67l-0.46,2.16c-0.48,2.24-1.6,3.77-4.99,3.77
                                          ...
                                          c-0.02,0.13-0.05,0.27-0.05,0.38c-0.02,0.67,0.38,1.05,1.26,1.05c1.03,0,1.62-0.52,1.81-1.43l0.48-2.31
                                          C234.68,63.56,234.71,63.43,234.71,63.31z" />
                                                <path className="st4" d="M244.57,62.45c-1.21,0.65-1.66,0.9-2.75,1.57l-1.17,5.49h-2.7l1.9-9.08l2.38-0.4l-0.1,1.26
                                          c0.92-0.54,1.66-0.92,2.47-1.26L244.57,62.45z" />
                                                <path className="st4" d="M245.18,63.52c0.46-2.14,1.46-3.52,4.41-3.52c1.76,0,3.07,0.76,3.02,2.33c-0.06,1.82-1.03,2.66-3.35,3.35
                                          c-1.14,0.34-1.16,0.34-1.97,0.55l-0.14,0.65c-0.07,0.34-0.04,0.65,0.46,0.65c0.98,0,2.41-0.48,3.69-1.03l0.45,1.91
                                          c-1.15,0.71-2.95,1.28-4.59,1.28c-1.93,0-2.72-0.84-2.67-2.43c0.01-0.34,0.06-0.73,0.15-1.13L245.18,63.52z M250.09,62.62
                                          c0.01-0.33-0.27-0.54-0.76-0.54c-0.98,0-1.28,0.55-1.44,1.32l-0.14,0.65c0.46-0.12,0.67-0.15,1.23-0.33
                                          C249.71,63.52,250.07,63.18,250.09,62.62z" />
                                                <path className="st4" d="M253.7,66.33h2.7l-0.66,3.17h-2.7L253.7,66.33z" />
                                            </g>
                                        </g>
                                        <path className="st4" d="M6.59,15.07C2.03,21.62,2.6,30.14,6.08,37.09c0.08,0.17,0.17,0.33,0.25,0.49c0.05,0.11,0.1,0.21,0.16,0.32
                                  ...
                                  c-0.19-0.24-0.37-0.49-0.56-0.74c-5.02-6.84-6.83-16.29-2.81-24.04" />
                                        <path className="st4" d="M20.74,9.55c-3.3,4.74-3.12,11.09-0.55,16.1c0.43,0.84,0.91,1.66,1.46,2.43c0.49,0.71,1.04,1.55,1.7,2.12
                                  ...
                                  c-0.31-0.21-0.61-0.44-0.91-0.67c-0.07-0.06-0.14-0.11-0.21-0.17c-3.21-2.53-5.75-5.98-6.95-9.9c-1.27-4.06-0.99-8.63,1.2-12.33" />
                                        <path className="st4" d="M32.63,5.43c-1.95,2.86-2.14,6.41-0.79,9.56c1.43,3.35,4.34,5.98,7.74,7.23c0.14,0.05,0.28,0.1,0.42,0.15
                                  ...
                                  c-0.36-0.09-0.76-0.22-1.11-0.35c-0.45-0.16-0.89-0.34-1.33-0.55c-0.81-0.39-1.59-0.87-2.32-1.42c-4.12-3.12-6.67-9.08-3.99-13.94" />
                                        <path className="st5" d="M250.31,18.82l0.37,1.56c0.1,0.45-0.18,0.81-0.63,0.81" />
                                        <path className="st5" d="M220.68,16.15c-0.09,0.43-0.21,0.98-0.28,1.34l-3.25,15.22l3.42-16.03L220.68,16.15z" />
                                        <polygon className="st5" points="123.28,26.33 121.49,32.69 123.28,26.34 " />
                                        <path className="st5" d="M250.68,20.38l-0.94-3.96c-0.74-2.87-2.83-4.22-7.54-4.22h-19.79c-0.46,0-0.91,0.21-1,0.65l-7.51,35.61
                                  ...
                                  l2.42-12.49l2.96-13.85c0.1-0.44,0.54-0.81,1-0.81l19.61-0.01C250.5,21.19,250.79,20.82,250.68,20.38" />
                                        <path className="st5" d="M278.57,5.94c-0.46,0.01-8.7,0-8.7,0c-0.46,0-1.04,0.49-1.29,0.87l-15.26,22.45c-0.26,0.38-0.56,0.36-0.66-0.08
                                  ...
                                  c0.28-0.36,0.24-0.8-0.21-0.8L278.57,5.94z" />
                                        <path className="st5" d="M176.44,12.23h-8.85c-0.45,0-0.91,0.16-1,0.61l-2.93,13.69l-2.92,13.11c-0.09,0.44-0.54,0.41-1,0.41h-5.82
                                  ...
                                  C176.46,12.65,176.59,12.23,176.44,12.23z" />
                                        <path className="st5" d="M88.26,12.2h-9.49c-0.46,0-0.91,0.11-1.02,0.56l-1.71,7.41c-0.1,0.44,0.19,0.79,0.65,0.79h9.09
                                  c0.46,0,0.91-0.41,1.01-0.86l1.65-7.47C88.44,12.63,88.57,12.2,88.26,12.2z" />
                                        <path className="st5" d="M76.07,23.45c-0.45,0-0.91,0.36-1.01,0.81l-1.28,5.65l-2.86,13.05c0,0-1.52,6.94-1.66,7.37
                                  ...
                                  c0.1-0.45-0.17-0.86-0.63-0.86" />
                                        <path className="st5" d="M198.84,12.14c-15.97,0-19.78,9.87-21.9,19.65c-2.12,9.97-1.94,17.86,14.58,17.86h0.6c6.55,0,14.52,0,14.52,0
                                  ...
                                  c5.12,0,6.21,2.54,6.21,5.36" />
                                        <path className="st5" d="M129.84,39.36c0,0,4.47-10.86,5.49-17.14c1.39-8.4-2.81-20.59-19.07-20.59c-16.15,0-23.16,11.63-25.85,24.28
                                  ...
                                  c9.69-0.73,11.67,6.11,9.32,13.97L121.4,32.69z" />
                                    </svg>
                                </i>
                                <i className="ico ico-80 margin-30 flex-auto">
                                    <svg viewBox="0 0 711.20123 383.5975" width="100%" height="100%">
                                ...
                                <i className="ico ico-80 margin-30 flex-auto">
                                    <svg fillRule="evenodd" viewBox="0 0 5.5555557 5.5555555" width="100%" height="100%">
